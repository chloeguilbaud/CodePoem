...
public class InMemoryOrderRepository implements OrderRepository {
    ...
    public void init() throws HiShoeNotFoundException {
        ...
        orders.put(order1Id, new Order(order1Id, clientRepository.get(UUID.fromString("99999999-9999-9999-9999-999999999999")), hiShoeRepository.get(1)));

        UUID order2Id = UUID.fromString("aaaaaaa2-0000-0000-0000-000000000002");
        orders.put(order2Id, new Order(order2Id, clientRepository.get(UUID.fromString("99999999-9999-9999-9999-999999999999")), hiShoeRepository.get(2)));

        UUID order3Id = UUID.fromString("aaaaaaa3-0000-0000-0000-000000000003");
        orders.put(order3Id, new Order(order3Id, clientRepository.get(UUID.fromString("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa")), hiShoeRepository.get(3)));

        UUID order4Id = UUID.fromString("aaaaaaa4-0000-0000-0000-000000000004");
        orders.put(order4Id, new Order(order4Id, clientRepository.get(UUID.fromString("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa")), hiShoeRepository.get(4)));

        UUID order5Id = UUID.fromString("aaaaaaa5-0000-0000-0000-000000000005");
        orders.put(order5Id, new Order(order5Id, clientRepository.get(UUID.fromString("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb")), hiShoeRepository.get(1)));
    }
